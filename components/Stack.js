...
export default function Stack() {
  ...
  const stackIcon = (
    <svg
      ...
      width="40"
      height="40"
      className="mr-4 fill-green-300 bg-black rounded-full p-2"
    >
  ...
  const tailWindIcon = (
    <svg
      ...
      viewBox="0 0 15 15"
      width={svgSize}
      className="fill-green-300 stroke-green-300"
      xmlns="http://www.w3.org/2000/svg"
    >
      <path
        clip-rule="evenodd"
  ...
  return (
    <div className="bg-gray-800 h-screen w-full relative pt-24">
      <div>
        ...
        <div className="ml-8 mr-8 flex justify-center">
          <motion.div
          ...
          >
            <p className="text-lg text-center mb-2 border-b border-green-300 text-gray-500 uppercase">
              What i started with
            </p>
            {[
              ...
              return (
                <div className="border-b border-gray-600">
                  <div className="relative px-10 flex items-center justify-center py-2 w-fit">
                    ...
                    <p className="ml-6 text-sm text-green-300 border-b border-green-300">
                      {item.name}
                    </p>
                  </div>
                </div>
